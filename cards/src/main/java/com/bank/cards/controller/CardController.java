...
@Tag(
        name = "CRUD REST APIs for Cards in YoloBank",
        description = "CRUD REST APIs in YoloBank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
	...
	public ResponseEntity<CardDto> fetchCardDetails(@RequestParam 
		...
		return  ResponseEntity
				.status(HttpStatus.OK).body(cardDto);
	...
	public ResponseEntity<ResponseDto> deleteCardDetails(@RequestParam 
		...
		boolean isDeleted = iCardService.deleteCardDetails(mobileNumber);
